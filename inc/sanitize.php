...
class westcpa_Sanitize {
	...
	public function clean() {
		 ...
		 */
		do_action( 'westcpa_pre_sanitize', $sanitized );
		 ...
		 */
		do_action( 'westcpa_post_sanitize', $sanitized );
	...
	public function set_type( $type ) {
		...
		if ( empty( $type ) ) {
			...
			$check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'westcpa' ) );

		}

		if ( is_wp_error( $check ) ) {

			wp_die( $check->get_error_message(), __( 'Forgot data type', 'westcpa' ) );
...
$westcpa_sanitize = new westcpa_Sanitize();
